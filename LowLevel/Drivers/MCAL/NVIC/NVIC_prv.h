...
#define NVIC_ISER0_BASE        								(*(volatile u32 *)(NVIC_BASE_ADDR + 0x00))
#define NVIC_ISER1_BASE         							(*(volatile u32 *)(NVIC_BASE_ADDR + 0x04))
#define NVIC_ISER2_BASE        						        (*(volatile u32 *)(NVIC_BASE_ADDR + 0x08))
#define NVIC_ICER0_BASE         							(*(volatile u32 *)(NVIC_BASE_ADDR + 0x80))
#define NVIC_ICER1_BASE         						  	(*(volatile u32 *)(NVIC_BASE_ADDR + 0x84))
#define NVIC_ICER2_BASE         							(*(volatile u32 *)(NVIC_BASE_ADDR + 0x88))
